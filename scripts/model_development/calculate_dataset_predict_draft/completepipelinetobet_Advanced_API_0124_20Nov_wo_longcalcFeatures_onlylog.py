...
while dateofprediction[0] + datetime.timedelta(hours=hourd) < datetime.datetime.now():
    ...
    print("AUC: {}".format(roc_auc_score(y_test, y_pred_prob)), file=f)
    ...
    print("AUC scores computed using 10-fold cross-validation: {}".format(cv_auc), file=f)
    ...
    print("Accuracy scores computed using 10-fold cross-validation: {}".format(cv_acc), file=f)
    ...
    try:
        print(statistics.median(prestakepercentlist), file=f)
        print(statistics.median(profitpercent), file=f)
        print(statistics.median(zinseszins), file=f)
        print(statistics.median(current_profitpercent), file=f)
        print(statistics.median(current_zinseszins), file=f)
    except:
    ...
    print("most_current_day_pred_prob[0]", most_current_day_pred_prob[0], file=f)
    print("algoprediction", algoprediction, file=f)
    print(dateofprediction[0], file=f)
    print("most_current_day_pred_prob[0]", most_current_day_pred_prob[0])
    print("algoprediction", algoprediction)
    print(dateofprediction[0])
